...
const CoreValuesPage = () => {
  return (
    <div className="w-full bg-white flex flex-col min-h-screen">
      ...
      {/* Hero Banner for Core Values Page */}
      <section className="relative w-full h-[400px] bg-gray-900 flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Our Core Values</h1>
          <div className="flex items-center justify-center gap-2 text-white/80 font-medium">
            <a href="/" className="hover:text-white transition-colors">Home</a>
            <span>/</span>
            <a href="/about" className="hover:text-white transition-colors">About Us</a>
            <span>/</span>
            <span className="text-[#EBA525]">Our Core Values</span>
          </div>
        </div>
      </section>

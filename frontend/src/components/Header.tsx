        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden lg:flex items-center gap-1">
            ...
            <div className="relative group flex items-center">
              ...
              {/* Dropdown Menu */}
              <div className="absolute left-1/2 -translate-x-1/2 top-[calc(100%-8px)] w-52 bg-white border border-gray-100 rounded-xl shadow-xl py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform translate-y-2 group-hover:translate-y-0 z-50">
                <NavLink
        ...
        <div className="lg:hidden absolute top-20 left-0 w-full bg-white shadow-xl border-t border-gray-200 py-4 flex flex-col z-50">
          ...
          <div className="border-b border-gray-100">
            <button
              ...
              className="w-full flex items-center justify-between px-6 py-3 font-semibold text-gray-700 hover:bg-gray-50 text-left transition-colors"
            >
              <span>About Us</span>
              <ChevronDown className={`w-4 h-4 transition-transform duration-200 ${isAboutMobileOpen ? 'rotate-180 text-[#A32924]' : 'text-gray-500'}`} />
            </button>
            {isAboutMobileOpen && (
              <div className="bg-gray-50/50 pl-8 pr-6 py-2 flex flex-col gap-1 border-t border-gray-100">
                <NavLink
                  to="/about/core-values"
                  onClick={() => {
                  ...
                  className="py-2 text-sm font-semibold text-gray-600 hover:text-[#A32924] transition-colors"
                >
                  Core Values
                </NavLink>
              </div>
